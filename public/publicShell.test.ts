...
async function readAppSources() {
  const files = [
    ...
    "../src/viewer/components/previewBody/ImagePreview.tsx",
    "../src/viewer/components/previewBody/MediaPreviews.tsx",
    "../src/viewer/components/previewBody/SimplePreviews.tsx",
    "../src/viewer/components/previewBody/shared.tsx",
    "../src/viewer/previewBodyState.ts",
...
test("public UI no longer shows connect lock icon or connection settings button", async () => {
  ...
  assert.match(html, /sidebarWidth=\{sidebarWidth\}/);
  assert.doesNotMatch(html, /"--sidebar-width-icon": "3rem"/);
