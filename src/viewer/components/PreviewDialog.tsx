...
export function PreviewDialog() {
  ...
  return (
    ...
    >
      ...
      >
        <section className="preview-rating-section mx-2 grid min-h-8 grid-cols-[minmax(82px,104px)_minmax(0,1fr)] items-center gap-4 border-b border-border pb-3 min-[900px]:h-14 min-[900px]:pb-0 max-[540px]:gap-3">
