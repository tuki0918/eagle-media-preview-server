  ...
  return (
    <section id="loginView" className="login-view grid min-h-dvh place-items-center px-4 py-9">
      ...
      >
        ...
        <p
          id="connectMessage"
          className="connect-message fixed bottom-[max(24px,env(safe-area-inset-bottom))] left-1/2 z-10 w-[min(320px,calc(100vw-32px))] -translate-x-1/2 px-2 text-center text-app-muted"
          aria-live="polite"
        />
      </form>
    </section>
